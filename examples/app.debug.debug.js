...
console.log('DEBUG: app.debug.js:2');
...
console.log('DEBUG: app.debug.js:8');
function main() {
  console.log('DEBUG: app.js:7');
  console.log('DEBUG: app.debug.js:10');
...
console.log('DEBUG: app.debug.js:51');
async function asyncExample() {
  console.log('DEBUG: app.js:40');
  console.log('DEBUG: app.debug.js:53');
  const delay = (ms) => new Promise(resolve => setTimeout(resolve, ms));
  
  console.log('Starting async operation...');
  console.log('DEBUG: app.js:43');
  console.log('DEBUG: app.debug.js:57');
  await delay(1000);
...
console.log('DEBUG: app.debug.js:63');
module.exports = { main, asyncExample };

// Run if this is the main module
console.log('DEBUG: app.js:51');
console.log('DEBUG: app.debug.js:67');
if (require.main === module) {
  console.log('DEBUG: app.js:52');
  console.log('DEBUG: app.debug.js:69');
  main();
  console.log('DEBUG: app.js:53');
  console.log('DEBUG: app.debug.js:71');
  asyncExample();
}